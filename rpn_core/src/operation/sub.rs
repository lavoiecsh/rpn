...
/// ```
/// # use rpn_core::operation::{Operation, OperationError, Push, Sub};
...
impl<N: Number, S: Stack<N>> Operation<N, S> for Sub {
...
mod tests {
    ...
    fn sub_pushes_result_of_subtraction() {
        ...
        let result = Sub.evaluate(&stack).unwrap();
